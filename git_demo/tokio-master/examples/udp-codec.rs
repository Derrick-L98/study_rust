...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    // Start off by sending a ping from a to b, afterwards we just print out what they send us and continually send pings
    // 首先从a向b发送ping，然后我们只打印出他们发送给我们的内容，并不断发送ping
