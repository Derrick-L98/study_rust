...
g++ -I../include/ getAllInstances.cpp -L../ -lnacos-cli -o getAllInstances.out
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/develop/natest/nacos-sdk-cpp-master/examples/
